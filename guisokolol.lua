...
library.theme = {
    ...
    bordercolor = Color3.fromRGB(150, 0, 0),
    accentcolor = Color3.fromRGB(255, 255, 255),
    accentcolor2 = Color3.fromRGB(255, 255, 255),
    outlinecolor = Color3.fromRGB(25, 0, 0),
    outlinecolor2 = Color3.fromRGB(50, 0, 0),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(255, 255, 255),
    topheight = 48,
    topcolor = Color3.fromRGB(255, 0, 0),
    topcolor2 = Color3.fromRGB(30, 30, 30),
    buttoncolor = Color3.fromRGB(49, 0, 0),
    buttoncolor2 = Color3.fromRGB(39, 0, 0),
